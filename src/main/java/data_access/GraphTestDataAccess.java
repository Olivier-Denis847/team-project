...
public class GraphTestDataAccess implements GraphDataAccessInterface {
    ...
    public GraphTestDataAccess() {
        ...
        // Define Categories
        // Note: The 'new Date()' here is just for the Label creation, not the
        // transaction itself.
        Label housing = new Label(1, "Housing", "blue", "Mortgage/Rent");
        Label groceries = new Label(2, "Groceries", "green", "Supermarket");
        Label utilities = new Label(3, "Utilities", "orange", "Electric/Water");
        Label transportation = new Label(4, "Transportation", "yellow", "Gas/Commute");
        Label healthcare = new Label(5, "Healthcare", "red", "Medical");
        Label education = new Label(6, "Education", "purple", "School/Kids");
        Label dining = new Label(7, "Dining Out", "pink", "Restaurants");
        Label shopping = new Label(8, "Shopping", "cyan", "Clothing/Misc");
        Label incomePrimary = new Label(9, "Salary (Pri)", "darkgreen", "Main Job");
        Label incomeSec = new Label(10, "Salary (Sec)", "lightgreen", "Part-time/Gig");
        ...
        while (cal.getTime().before(today)) {
            ...
            for (int i = 0; i < dailyTransactions; i++) {
                ...
                if (typeChance < 40) {
                    ...
                    allEntries.add(new Transaction(id++, round(amount), Arrays.asList(transportation),
