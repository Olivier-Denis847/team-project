...
public class LabelTest {
    ...
    public void testLabelEntity() {
        ...
        Label label = new Label(1, "Food", "Red", 101, 50.0, "Lunch");
        ...
        Assertions.assertEquals(101, label.getUserId());
        Assertions.assertEquals(50.0, label.getAmount());
        ...
        Assertions.assertEquals(100.0, label.getAmount());
